...
These were the prompts used to create this version. Note that revisions were still made afterward; the pure output from Claude Opus was not the final version.
